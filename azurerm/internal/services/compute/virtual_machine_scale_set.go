...
func flattenVirtualMachineScaleSetIPConfiguration(input compute.VirtualMachineScaleSetIPConfiguration) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"application_gateway_backend_address_pool_ids": pluginsdk.NewSet(pluginsdk.HashString, applicationGatewayBackendAddressPoolIds),
		"application_security_group_ids":               pluginsdk.NewSet(pluginsdk.HashString, applicationSecurityGroupIds),
		"load_balancer_backend_address_pool_ids":       pluginsdk.NewSet(pluginsdk.HashString, loadBalancerBackendAddressPoolIds),
		"load_balancer_inbound_nat_rules_ids":          pluginsdk.NewSet(pluginsdk.HashString, loadBalancerInboundNatRuleIds),
	}
}
