...
func importVirtualMachine(osType compute.OperatingSystemTypes, resourceType string) func(d *pluginsdk.ResourceData, meta interface{}) (data []*pluginsdk.ResourceData, err error) {
