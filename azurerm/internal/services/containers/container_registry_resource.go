...
func resourceContainerRegistry() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		...
		CustomizeDiff: func(d *pluginsdk.ResourceDiff, v interface{}) error {
...
func applyGeoReplicationLocations(d *pluginsdk.ResourceData, meta interface{}, resourceGroup string, name string, oldGeoReplicationLocations []interface{}, newGeoReplicationLocations []interface{}) error {
...
func resourceContainerRegistryRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if replicationValues != nil || len(replicationValues) > 1 {
		georeplication_locations := &pluginsdk.Set{F: pluginsdk.HashString}
